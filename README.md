...
<p align="center">
  <img src="zkteco-adms-listener/static/assets/didban-readme-hero.svg" alt="دیدبان — وضعیت دستگاه‌ها، کارکنان و داده‌های هویتی را از یک مرکز کنترل کنید." width="95%">
</p>
